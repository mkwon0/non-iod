...
--
-- Host: localhost    Database: tpcc_bench
-- ------------------------------------------------------
...
CREATE DATABASE IF NOT EXISTS `tpcc_bench` CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' ;
GRANT ALL PRIVILEGES ON `tpcc_bench`.* TO 'username'@'%' ;
GRANT ALL PRIVILEGES ON `tpcc_bench`.* TO 'username'@'localhost' ;
FLUSH PRIVILEGES ;
