...
--
-- Host: localhost    Database: tpcc_bench3
-- ------------------------------------------------------
...
--
-- Current Database: `tpcc_bench3`
--
DROP USER IF EXISTS 'username3'@'%';
DROP USER IF EXISTS 'username3'@'localhost';
CREATE USER 'username3'@'localhost' IDENTIFIED WITH mysql_native_password BY 'userpassword3';
CREATE USER 'username3'@'%' IDENTIFIED WITH mysql_native_password BY 'userpassword3';

CREATE DATABASE IF NOT EXISTS `tpcc_bench3` CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' ;
GRANT ALL PRIVILEGES ON `tpcc_bench3`.* TO 'username3'@'%' ;
GRANT ALL PRIVILEGES ON `tpcc_bench3`.* TO 'username3'@'localhost' ;
FLUSH PRIVILEGES ;
