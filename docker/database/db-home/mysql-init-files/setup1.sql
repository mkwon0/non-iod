...
--
-- Host: localhost    Database: tpcc_bench1
-- ------------------------------------------------------
...
--
-- Current Database: `tpcc_bench1`
--
DROP USER IF EXISTS 'username1'@'%';
DROP USER IF EXISTS 'username1'@'localhost';
CREATE USER 'username1'@'localhost' IDENTIFIED WITH mysql_native_password BY 'userpassword1';
CREATE USER 'username1'@'%' IDENTIFIED WITH mysql_native_password BY 'userpassword1';

CREATE DATABASE IF NOT EXISTS `tpcc_bench1` CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' ;
GRANT ALL PRIVILEGES ON `tpcc_bench1`.* TO 'username1'@'%' ;
GRANT ALL PRIVILEGES ON `tpcc_bench1`.* TO 'username1'@'localhost' ;
FLUSH PRIVILEGES ;
